    ...
    result: [
      {
        ...
        correct_answer: "Bima",
        incorrect_answer: ["Siti", "Dokter Siti", "Teman Bima"],
      },
      {
        question: "Apa yang membuat Bima merasa tubuhnya cepat lelah?",
        correct_answer: "Kurang makan makanan sehat",
        incorrect_answer: [
          "Kurang tidur",
      ...
      {
        question:
          "Siapa yang memberikan ceramah tentang kesehatan di sekolah Bima?",
        correct_answer: "Dokter Siti",
        incorrect_answer: ["Guru olahraga", "Kepala sekolah", "Orang tua Bima"],
      },
      {
        question: "Apa yang dilakukan Bima untuk menjaga kesehatannya?",
        correct_answer: "Berolahraga setiap pagi",
        incorrect_answer: [
      ...
      {
        question: "Apa yang dibawa Bima ke sekolah sebagai bekal?",
        correct_answer: "Buah-buahan",
        incorrect_answer: ["Permen", "Kue", "Minuman bersoda"],
      },
      {
        question:
          "Apa yang dirasakan Bima setelah beberapa minggu menjaga kesehatannya?",
        correct_answer: "Tubuhnya menjadi lebih bugar",
        incorrect_answer: [
          "Tubuhnya menjadi lebih lemah",
          "Dia menjadi malas",
          "Dia menjadi sakit",
        ],
      },
      {
        question:
          "Apa yang dilakukan teman-teman Bima setelah melihat perubahan pada Bima?",
        correct_answer: "Mengikuti kebiasaan sehat Bima",
        incorrect_answer: [
          "Mengabaikan Bima",
          "Bermain video game",
          "Makan permen bersama",
        ],
      },
      {
        question:
          "Apa yang diadakan di desa yang diikuti oleh Bima dan teman-temannya?",
        correct_answer: "Lomba lari",
        incorrect_answer: ["Lomba makan", "Lomba menggambar", "Lomba menyanyi"],
      },
      {
        question: "Apa pesan moral dari cerita ini?",
        correct_answer: "Pentingnya menjaga kesehatan dengan kebiasaan sehat",
        incorrect_answer: [
      ...
      {
        question:
          "Apa yang dilakukan Bima dan teman-temannya setelah memenangkan lomba lari?",
        correct_answer: "Terus menjaga kesehatan",
        incorrect_answer: [
          "Makan permen",
          "Bermain video game",
          "Tidur sepanjang hari",

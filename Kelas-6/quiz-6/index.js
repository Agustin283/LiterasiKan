document.addEventListener("DOMContentLoaded", () => {
  ...
  const quizData = {
    result: [
      {
        question:
          "Apa yang menjadi latar belakang cerita 'Petualangan di Tengah Bencana Alam'?",
        correct_answer: "Bencana alam yang tiba-tiba",
        incorrect_answer: [
      ...
      {
        question: "Siapa tokoh utama dalam cerita tersebut?",
        correct_answer: "Seorang petualang",
        incorrect_answer: [
          "Seorang ilmuwan",
          "Seorang petani",
          "Seorang anak kecil",
      ...
      {
        question: "Bencana alam apa yang terjadi dalam cerita?",
        correct_answer: "Letusan gunung berapi",
        incorrect_answer: ["Gempa bumi", "Banjir", "Angin topan"],
      },
      {
        question: "Bagaimana tokoh utama menyelamatkan diri dari bencana?",
        correct_answer: "Melarikan diri ke tempat yang lebih tinggi",
        incorrect_answer: [
      ...
      {
        question: "Apa yang dilakukan tokoh utama untuk membantu orang lain?",
        correct_answer: "Menyusun rencana evakuasi",
        incorrect_answer: [
          "Memberikan makanan",
      ...
      {
        question: "Apa yang menjadi pelajaran dari cerita ini?",
      ...
      {
        question: "Siapa yang membantu tokoh utama dalam cerita?",
        correct_answer: "Penduduk setempat",
        incorrect_answer: ["Teman-temannya", "Keluarganya", "Tim penyelamat"],
      },
      {
        question: "Apa yang dilakukan tokoh utama setelah bencana berakhir?",
        correct_answer: "Membantu membangun kembali desa",
        incorrect_answer: [
          "Kembali ke rumah",
          "Pergi ke kota lain",
      ...
      {
        question: "Apa yang membuat cerita ini menarik untuk dibaca?",
        correct_answer: "Semua jawaban benar",
        incorrect_answer: [
      ...
      {
        question:
          "Bagaimana akhir dari cerita 'Petualangan di Tengah Bencana Alam'?",
        correct_answer: "Semua orang selamat",
        incorrect_answer: [
          "Tokoh utama meninggal",
          "Desa hancur total",
          "Tokoh utama pindah ke kota",
        ],
      },
    ],
  };
